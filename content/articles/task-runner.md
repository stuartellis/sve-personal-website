...
slug = "task-runner"
date = "2026-03-17T07:30:00+00:00"
...
This command installs version 3.49.1 of Task with [mise](https://mise.jdx.dev/) and makes it available to your user account:

```shell
mise use -gy task@3.49.1
```

### Installing Task with npm

This command installs version 3.49.1 of Task with [npm](https://docs.npmjs.com/) and makes it available to your user account:

```shell
npm install -g @go-task/cli@3.49.1
```
...
```shell
./install-task.sh -b $HOME/.local/bin v3.49.1
```
